  ...
  return (
    <main className="min-h-screen bg-gunmetal text-white">
      <div className="mx-auto max-w-3xl px-6 py-14 md:px-8">
        ...
        <h1 className="font-display text-4xl uppercase tracking-tight">Returns &amp; Refunds</h1>
        ...
        <div className="mt-10 space-y-10 text-brushed-aluminum leading-7">
          ...
          <section>
            <h2 className="mb-3 font-display text-lg uppercase tracking-wide text-white">Made to order means made for you</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg uppercase tracking-wide text-white">We stand behind our work</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg uppercase tracking-wide text-white">Refund processing</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg uppercase tracking-wide text-white">Color variation</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg uppercase tracking-wide text-white">Questions?</h2>
            <p>
              Email us at{" "}
              <a href="mailto:info@3dpressusa.com" className="text-federal-blue underline underline-offset-2 hover:text-white">
                info@3dpressusa.com
