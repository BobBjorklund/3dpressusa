...
export default function BaseUnitPage() {
  return (
    <main className="relative min-h-screen text-white">
      <div className="fixed inset-0 -z-10 bg-gunmetal" />
      ...
      <section className="mx-auto max-w-7xl px-6 py-10 md:px-8">
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              <h1 className="font-display text-4xl uppercase tracking-tight md:text-5xl">Hitch Cover Base Unit</h1>
              <p className="mt-3 text-lg leading-7 text-brushed-aluminum">
            ...
            <ContentCard>
              <div className="mb-3 font-mono text-[10px] uppercase tracking-[0.25em] text-brushed-aluminum">What&apos;s Included</div>
                ...
                {[
                  ...
                  <li key={item.label} className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-2 text-xs text-brushed-aluminum">{item.detail}</span>
                    </div>
                  </li>
                ))}
              </ul>
